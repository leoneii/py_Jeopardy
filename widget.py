...
import time
from PySide6.QtCore import (QCoreApplication, QTimer, QEventLoop, QDate, QDateTime, QLocale, QMetaObject, QObject,
                            QPoint, QRect, QSize, QTime, QUrl, Qt, QEvent)
...
query.nextResult()
query.next()
# Раскомментировать после уточнения пути к базе данных
...
ntem = ["Анекдоты", "Нам песня строить и жить помогает", "Улицы в лицах", "Живопись и музыка", "Меценаты",
        "Исторические анекдоты", "Покорители"]
# цена вопроса
